...
exports.init = function (cli) {
  ...
  var getConfigHandlers = {
    ...
    'facebookClientId': createGetConfigHandler(mobile.getLiveSettings, 'facebook', 'appId'),
    'facebookClientSecret': createGetConfigHandler(mobile.getLiveSettings, 'facebook', 'secret'),
    'twitterClientId': createGetConfigHandler(mobile.getLiveSettings, 'twitter', 'appId'),
    'twitterClientSecret': createGetConfigHandler(mobile.getLiveSettings, 'twitter', 'secret'),
    'googleClientId': createGetConfigHandler(mobile.getLiveSettings, 'google', 'appId'),
    'googleClientSecret': createGetConfigHandler(mobile.getLiveSettings, 'google', 'secret'),
